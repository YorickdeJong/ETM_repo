                    ...
                    boxShadow: '4px 4px 8px rgba(0, 0, 0, 0.2)'}}>
                        <div style = {{width: isSmallScreen ? '80%' : '45%', height: '100%', padding: '5%'}}>
                            <div style = {{display: 'flex', alignItems: 'center', marginTop: '15%'}}>
                                ...
                                <input type="text" placeholder="Naam + Achternaam" style = {{outline: 'none', border: 'none', fontSize: 19, borderBottom: '2px solid gray', marginLeft: '8%', flex: '1'}} />
                            </div>
                            ...
                            <div style = {{display: 'flex', alignItems: 'center', marginBottom: '10%', marginTop: '25%'}}>
                                ...
                                <input type="text" placeholder="Telefoonnummer" style = {{border: 'none', fontSize: 19,borderBottom: '2px solid gray', marginLeft: '8%', flex: '1'}} />
                            </div>
                        </div>
                        <div style = {{width: isSmallScreen ? '80%' : '45%', marginTop: isSmallScreenHeight ? '-3%' : isSmallScreen ? '-10%' : '8%', marginRight: '5%', height: isSmallScreen ? '90%' : '70%', backgroundColor: '#FFF9F5', marginLeft: isSmallScreen ? '10%' : '3%', borderRadius: 20,
